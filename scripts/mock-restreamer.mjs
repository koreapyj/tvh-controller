...
//
// Always advertises {id:'raw-argv',version:1} in /v1/status.templates — the
// wire contract only carries pre-rendered argv now, so every node (real or
// mock) is raw-argv-only.
//
